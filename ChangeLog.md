...
- `Ufs::unlink()` ([#84](https://github.com/realchonk/fuse-ufs/pull/84))
- `Ufs::inode_modify()` ([#84](https://github.com/realchonk/fuse-ufs/pull/84))
...
[0.5.0]: https://github.com/realchonk/fuse-ufs/compare/0.4.3...HEAD
